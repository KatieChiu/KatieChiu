...
A full-stack platform designed to centralize and automate communication processes, integrating different messaging providers and managing campaigns, templates, contacts and message delivery.

**Technologies:** C# · .NET · Blazor · DevExtreme · PostgreSQL · Swagger
...
A modern and responsive web solution focused on presenting the firm's services, strengthening its digital presence and facilitating client contact.
